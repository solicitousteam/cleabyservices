...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      <div class="page-header d-flex align-items-center" style="background-image: url('assets/img/Contact-Us-banner.jpg');">
      ...
      <nav>
        <div class="container">
          <ol>
            <li><a class="ban-ul-02" href="index.html">Home</a></li>
            <li>Contact</li>
          </ol>
        </div>
      </nav>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container mt-4">
      ...
      <div class="credits">
        ...
        Powered With ❤️ By<a href="https://artificialintelligence.host/">     Solicitous</a>
      </div>
    </div>
